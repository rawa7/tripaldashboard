...
ALTER TABLE accommodation_images ADD COLUMN media_type text DEFAULT 'image';

-- Add thumbnail_url column for videos
ALTER TABLE accommodation_images ADD COLUMN thumbnail_url text;

-- Add display_order column for ordering media items
ALTER TABLE accommodation_images ADD COLUMN display_order integer DEFAULT 0;
